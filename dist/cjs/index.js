...
var useAnimation = function () {
    var animate = React.useContext(AnimationContext).animate;
    return { animate: animate, Animation: Animation$1 };
};
var useAnimationContext = function () {
    return __assign(__assign({}, React.useContext(AnimationContext)), { Animation: Animation$1 });
};
function AnimationContextProvider$1(_a) {
    var children = _a.children;
    var _b = React.useState({}), animations = _b[0], setAnimations = _b[1];
...
exports.AnimationContextProvider = AnimationContextProvider;
